...
.Link
  https://github.com/aafksab/posh-cowsay
.Example
  cowsay moo
  Description
  -----------
        ...
        \  ^__^
         \ (==)\________
           (__)\        )\/\
                ...
                ||     ||
.Example
  cowthink I dont have to share everything
  Description
  -----------
  The borg mode can be enabled by passing -b option, giving a cow that
  has joined the Collective:
 _________________________________
< I dont have to share everything >
 ---------------------------------
      o  ^__^             
       o (oo)\________    
         (__)\        )\/\
...
function Print-CowSay($eyes = "oo", $tongue = " ") {
	Write-Output "      \  ^__^             "
...
function Print-CowThink($eyes = "oo", $tongue = " ") {
	Write-Output "      o  ^__^             "
...
# Exports
Export-ModuleMember Cowsay -ErrorAction Continue
Export-ModuleMember Cowthink -ErrorAction Continue
Export-ModuleMember Split-Word -ErrorAction Continue
Export-ModuleMember Split-Message -ErrorAction Continue
